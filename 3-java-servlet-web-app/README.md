...
| <img src="ReadmeFiles/sign-in-2.png" width="200"> | [**1.2 Sign-in with Azure Active Directory B2C**](./1-Authentication/sign-in-b2c) </br> Sign your customers in with **Azure Active Directory B2C**. Learn to integrate with **external social identity providers**. Learn how to use **user-flows** and **custom policies**. |

### Chapter 2: Get an Access Token and call Microsoft Graph

|                |               |
|----------------|---------------|
| <img src="ReadmeFiles/topology.png" width="200"> | [**2.1 Acquire an Access Token from Microsoft Entra ID and call Microsoft Graph**](./2-Authorization-I/call-graph) </br> Enable your web app to acquire an Access Token to Authorize it to call **Microsoft Graph API**. |
