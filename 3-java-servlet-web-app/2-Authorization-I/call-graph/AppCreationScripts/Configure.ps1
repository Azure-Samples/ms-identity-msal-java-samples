...
#> 
   ...
   Write-Host "Creating the Microsoft Entra application (java-servlet-webapp-call-graph)"
   ...
   $webAppMicrosoft Entra IDApplication = New-AzureADApplication -DisplayName "java-servlet-webapp-call-graph" `
