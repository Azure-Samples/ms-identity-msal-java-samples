...
#> 
   ...
   Write-Host "Creating the Microsoft Entra application (java-servlet-webapp-roles)"
   ...
   $webAppMicrosoft Entra IDApplication = New-AzureADApplication -DisplayName "java-servlet-webapp-roles" `
