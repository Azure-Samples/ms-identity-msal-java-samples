...
Function CleanupUsers
{
    <#
    .Description
    This function removes the users created in the Microsoft Entra tenant by the CreateUsersAndRoles.ps1 script.
    #>
    ...
    RemoveUser -userPrincipal "$appName-PrivilegedAdmin@$tenantName"
    RemoveUser -userPrincipal "$appName-RegularUser@$tenantName"
