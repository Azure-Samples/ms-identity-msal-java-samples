...
#> 
   ...
   Write-Host "Creating the Microsoft Entra application (java-servlet-webapp-groups)"
   ...
   $webAppMicrosoft Entra IDApplication = New-AzureADApplication -DisplayName "java-servlet-webapp-groups" `
