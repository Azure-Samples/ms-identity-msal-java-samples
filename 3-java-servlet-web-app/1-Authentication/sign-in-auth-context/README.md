...
2. Go to the "Authentication Contexts" page, and click on New Authentication context. Give it a name (e.g. "MFA") and select and id from the list, for example "c1". Ensure the "Publish To Apps" checkbox is checked. Make a note of the ID.
