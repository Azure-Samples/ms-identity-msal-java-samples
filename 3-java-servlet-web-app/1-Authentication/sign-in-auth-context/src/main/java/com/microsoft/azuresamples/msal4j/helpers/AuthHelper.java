...
public class AuthHelper {
    ...
    public static void signIn(IdentityContextAdapter contextAdapter) throws AuthException, IOException {
        ...
        if (!contextAdapter.getContext().isAuthenticated()) {
            challengeUser(contextAdapter, null);
        }
    }
    ...
    public static void challengeUser(IdentityContextAdapter contextAdapter, String authenticationContextId) throws IOException {
        ...
        AuthorizationRequestUrlParameters.Builder builder = AuthorizationRequestUrlParameters
        ...
        // Add claims={"id_token":{"acrs":{"essential":true,"value":"c1"}}} to the authorization request
        if (authenticationContextId != null && !authenticationContextId.isEmpty() ) {
            ClaimsRequest claimsRequest = new ClaimsRequest();
            claimsRequest.requestClaimInIdToken("acrs", new RequestedClaimAdditionalInfo(true, authenticationContextId, null));
