...
public class Config {
    ...
    private static final String[] REQUIRED = {
            ...
            "app.protect.authenticated_mfa",
            "app.protect.authContextId",
    ...
    public static final String PROTECTED_MFA_ENDPOINTS = Config.getProperty("app.protect.authenticated_mfa");

    public static final String AUTHENTICATION_CONTEXT_ID_MFA = Config.getProperty("app.protect.authContextIdMfa");
