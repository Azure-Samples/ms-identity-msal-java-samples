...
#> 
   ...
   Write-Host "Creating the Microsoft Entra application (java-spring-webapp-call-graph)"
   ...
   $webAppMicrosoft Entra IDApplication = New-AzureADApplication -DisplayName "java-spring-webapp-call-graph" `
