...
2. Update your **Microsoft Entra ID App Registration**'s redirect URIs from the **Microsoft Entra portal**, in order to include the redirect URI of your Azure App Service hosted Java web application.
...
2. You may import the secrets from a secure location such as:
   ...
   2. **Environment Variables** You may configure an environment variable from Microsoft Entra portal or use the Azure Tools extension for VSCode.
      - Microsoft Entra portal: *Microsoft Entra portal > App Services > YourAppName (e.g. example-domain) > Configuration.*
