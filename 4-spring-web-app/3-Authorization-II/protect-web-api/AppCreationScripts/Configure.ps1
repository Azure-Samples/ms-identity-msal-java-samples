...
#> 
   ...
   Write-Host "Creating the Microsoft Entra application (java-spring-webapp-auth)"
   ...
   $webAppMicrosoft Entra IDApplication = New-AzureADApplication -DisplayName "java-spring-webapp-auth" `
