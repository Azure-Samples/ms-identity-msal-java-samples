...
#> 
   ...
   Write-Host "Creating the Microsoft Entra application (java-spring-webapp-roles)"
   ...
   $webAppMicrosoft Entra IDApplication = New-AzureADApplication -DisplayName "java-spring-webapp-roles" `
   ...
   { 
    ...
    $appRoles.Add($newRole)
    Set-AzureADApplication -ObjectId $webAppMicrosoft Entra IDApplication.ObjectId -AppRoles $appRoles
  ...
  $dictionary = @{ "Enter_Your_Tenant_ID_Here" = $tenantId;"Enter_Your_Client_ID_Here" = $webAppMicrosoft Entra IDApplication.AppId;"Enter_Your_Client_Secret_Here" = $webAppAppKey };
